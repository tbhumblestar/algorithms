#K번째 큰 수
#출처 : 인프런 / 파이썬 알고리즘 문제풀이(코딩테스트 대비) by 김태원 / 코드 구현력 기르기(2장)-3번문제
...
for i in range(n):
    ...
    for j in range(i+1,n):
        ...
        for m in range(j+1,n):
            ...
            res.add(val1 + val2 + val3)

res_list = list(res) #set은 정렬메서드가 없음
res_list.sort(reverse=True) #정렬기본이 오름차순임
print(res_list[k-1])